                ...
                {!conversation || conversation.messages.length === 0 ? (
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center space-y-4">
                      <p className="text-[var(--text-secondary)]">开始与 AI 对话...</p>
                  ...
                  >
                        ...
                        {message.role === "assistant" && (
                          <>
                            ...
                            {message.id === currentMessageId && currentWorkflowState && (
                              <motion.div variants={notionStaggerItem} className="ml-12">
                                <WorkflowTimeline
                    ...
                    {isStreaming &&
                      currentWorkflowState &&
                      !currentWorkflowState.nodes.some(n => n.status === "running") && (
                        <motion.div variants={notionStaggerItem}>
                          <AIThinking />
                        </motion.div>
                      )}
