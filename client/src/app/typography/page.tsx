    ...
    <main className="min-h-screen bg-[var(--surface-base)]">
      ...
      <div className="max-w-5xl mx-auto mb-12">
        <div className="mt-6">
          ...
          <Text variant="body-lg" className="mt-4">
            A comprehensive typographic scale designed for readability and visual hierarchy.
            Built with Inter for body text and DM Sans for display text.
          </Text>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        ...
        <Text variant="muted" className="mb-8">
          Four heading levels using DM Sans font family, responsive sizing, and proper semantic HTML
        </Text>
          ...
          <Card variant="elevated" padding="lg">
            ...
            <CardContent>
              <Text variant="body-lg">
                ...
                used for emphasis or introductory paragraphs.
              </Text>
            </CardContent>
          </Card>
          ...
          <Card variant="elevated" padding="lg">
            ...
            <CardContent>
              <Text variant="body">
                ...
                size used for most content throughout the application.
              </Text>
            </CardContent>
          </Card>
          ...
          <Card variant="elevated" padding="lg">
            ...
            <CardContent>
              <Text variant="body-sm">
                ...
                used for dense information or compact layouts.
              </Text>
            </CardContent>
          </Card>
        </div>
        ...
        <Card variant="elevated" padding="lg">
          <div className="space-y-6">
            <div>
              ...
              <Text variant="body">
                This is primary text color used for main content. It has the highest
                contrast against the background for optimal readability.
              </Text>
            </div>
            ...
            <div>
              ...
              <Text variant="muted">
                This is muted text color used for secondary information, descriptions,
                and less important content that should not compete with primary text.
              </Text>
            </div>
            ...
            <div>
              ...
              <Text variant="subtle">
                This is subtle text color used for metadata, timestamps, and
                supplementary information that should fade into the background.
              </Text>
            </div>
          </div>
        </Card>
      ...
      <div className="max-w-5xl mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card variant="outlined" padding="lg">
            <CardHeader>
              <CardTitle className="text-[var(--status-success)]">
                ✓ Do
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card variant="outlined" padding="lg">
            <CardHeader>
              <CardTitle className="text-[var(--status-error)]">
                ✗ Don't
              </CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3">
                ...
                <li className="flex gap-2">
                  <span className="text-[var(--status-error)]">•</span>
                  <Text variant="body-sm">
                    Don't use heading tags for styling alone
                  </Text>
                </li>
                <li className="flex gap-2">
                  <span className="text-[var(--status-error)]">•</span>
                ...
                <li className="flex gap-2">
                  <span className="text-[var(--status-error)]">•</span>
                  <Text variant="body-sm">
                    Don't use all caps for long sentences
                  </Text>
                </li>
              </ul>
            </CardContent>
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div>
                ...
                <Text variant="body-sm">
                  All heading components use proper semantic HTML tags (h1-h4) for
                  screen reader compatibility and SEO. Never use heading components
                  purely for styling—use Text component with appropriate variants instead.
                </Text>
              </div>
              ...
              <div>
                ...
                <Text variant="body-sm">
                  Fonts are optimized with Next.js font loading to prevent layout shift
                  and flash of unstyled text (FOUT). Display swap ensures text remains
                  visible during font download.
                </Text>
              </div>
            </div>
          </CardContent>
